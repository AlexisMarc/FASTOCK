package fastock.fastock.Class.empresa;
...
public class empresa {
    ...
    public empresa(Integer id,
            ...
            String imagen, Boolean estado, fastock.fastock.Class.empresa.especialidad especialidad,
            Set<fastock.fastock.Class.fabricacion.area> area) {
        this.id = id;
        this.nombre = nombre;
