...
public insumo(Integer id, @NotEmpty @Size(min = 2, max = 60) String nombre,
        @NotEmpty @Size(min = 20, max = 200) String descripcion, @NotEmpty @Size(min = 20, max = 200) String material,
        Boolean estado, List<yeilux.com.proyecto.Model.Class.insumo.tipo> tipo,
